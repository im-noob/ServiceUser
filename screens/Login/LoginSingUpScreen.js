...
export default class LoginSingUpScreen extends Component {
    constructor(props){
        super(props);
        this.state = {
                    ...
                    <ImageBackground source={require('../../assets/images/login.png')} style={{width:width,height:height,resizeMode:'contain'}}>
                        ...
                        <KeyboardAvoidingView style={{}} behavior='position' enabled>
                            <View style={{justifyContent:'space-between',flexDirection:'row',marginTop:20,padding:10,}}>
                                <View></View>
                                <Button  rounded light iconRight onPress={()=>{this.props.navigation.navigate('App')}}>
                            ...
                            <View style={{justifyContent:'center',flexDirection:'row',padding:10, backgroundColor:'#ffffff'}}>
                             ...
                             <Text style={{fontSize:35,color:'#000000',fontWeight:'900'}}>Ganga Services</Text>
                         
                          </View>
                          <View style={{justifyContent:'center',flexDirection:'row',padding:10, backgroundColor:'#ffffff'}}>
                             
                             <Text style={{fontSize:20,color:'#000000',fontWeight:'500'}}>Your Problem Our Solution </Text>
                         
                          </View>
                         
                          <View style={{justifyContent:'center',flexDirection:'row',padding:10, backgroundColor:'#ffffff'}}>
                             
                             <Text style={{fontSize:13,color:'#cecccc'}}>Quick . Affordable . Trusted</Text>
                            ...
                            <View style={{justifyContent:'center',flexDirection:'row',padding:10, backgroundColor:'#ffffff'}}>
                                 ...
                                 <Button onPress={()=>{this.submitLogin();}} dark>
                                     <Text style={{color:'#ffffff'}}>Login / SignUp</Text>
                                 </Button>
