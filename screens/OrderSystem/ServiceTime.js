                ...
                <Container>
                    ...
                    <Content>
                        ...
                        <View style={{marginTop:height/6 ,margin:10}}>
                            <Text style={{fontSize:20,fontWeight:'500'}}>At What time should the professional arrive?</Text>
                         
                        </View>
                        <Card> 
                            {/* <CardItem>
                            </CardItem> Successfual */}
                            <FlatList
                        ...
                        <Button full bordered onPress={()=>{this.props.navigation.navigate('Successfual');}} > 
